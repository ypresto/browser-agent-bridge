 ...
 * Original path: packages/injected/src/ariaSnapshot.ts
 *
 * Modifications:
 * - Fixed import paths to use relative imports with .js extensions
 * - Changed @isomorphic/ariaSnapshot to ./ariaSnapshotTypes.js
 * - Changed @isomorphic/stringUtils to ./stringUtils.js
 * - Added @ts-nocheck for compatibility with strict TypeScript settings
 */

import { ariaPropsEqual } from './ariaSnapshotTypes.js';
import { escapeRegExp, longestCommonSubstring, normalizeWhiteSpace } from './stringUtils.js';
...
import type { AriaProps, AriaRegex, AriaTextValue, AriaRole, AriaTemplateNode } from './ariaSnapshotTypes.js';
import type { Box } from './domUtils.js';
